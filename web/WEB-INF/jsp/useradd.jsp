...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm" method="post"
                  action="${pageContext.request.contextPath }/user/addsave.html" enctype="multipart/form-data" >
                ...
                <div>
                    ...
                    <input type="file" id="a_idPicPath" name="attaches"/>
                    <font color="red"></font>
                </div>
                <%--<div>
                    <input type="hidden" id="errorInfo_wp" value="${uploadWpError}">
                    <label for="a_idPicPath">工作证件照：</label>
                    <input type="file" id="a_workPicPath" name="attaches"/>
                    <font color="red"></font>
                </div>--%>
