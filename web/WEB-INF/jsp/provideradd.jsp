        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/provideraddsave.html">
               ...
               <div>
                   ...
                   <label for="a_orgPicPath">营业执照：</label>
                   <input type="file" id="a_orgPicPath" name="attaches_provider"/>
                   <font color="red"></font>
               </div>
               <%--<div>
                   <input type="hidden" id="errorInfo_wp" value="${uploadWpError}">
                   <label for="a_orgPicPath">公司照：</label>
                   <input type="file" id="a_comPicPath" name="attaches_provider"/>
                   <font color="red"></font>
               </div>--%>
